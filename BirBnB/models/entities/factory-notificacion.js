  ...
  static mensajeSegunEstado(reserva) {
    ...
    switch (reserva.estado) {
      case EstadoReserva.PENDIENTE:
        return {
          contenido: new MensajeSobreUsuario(`{nombre} quiere reservar el alojamiento ${reserva.nombreAlojamiento}, en la fecha: ${inicioReserva}, por la cantidad de dias de: ${cantidadDias}`,
